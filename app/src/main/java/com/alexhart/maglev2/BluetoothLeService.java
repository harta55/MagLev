...
public class BluetoothLeService extends Service {
    ...
    // Implements callback methods for GATT events that get broadcast back to UI thread
    ...
    private void broadcastUpdate(final String action,
        ...
        if (UUID_RECEIVE.equals(characteristic.getUuid())) {
            ...
            i.putExtra(EXTRA_DATA, characteristic.getValue());
            sendBroadcast(i, Manifest.permission.BLUETOOTH);
        }
    }
    ...
    public boolean onUnbind(Intent intent) {
        //call close to cleanup up resources after disconnection (from UI thread)
        close();
    ...
    public boolean initialize() {
        // API level >18 fet a reference to BluetoothAdapter through BluetoothManager instead!
     ...
     *         is reported asynchronously through stateChange callback
     */
     ...
     * is sent asynchronously through the stateChange callback
     */
    ...
    /**
     * Call this after disconnecting from BLE device to cleanup resources
     */
    public void close() {
    ...
    /**
     * Request a read from a characteristic, reported asynchronously though callback
     *
    ...
    /**
     * Retrieves a list of supported GATT services on the device
     */
